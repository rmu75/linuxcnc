...
#ifndef FLATBUFFERS_GENERATED_EMCSTAT_H_
#define FLATBUFFERS_GENERATED_EMCSTAT_H_
...
struct JointSetBacklashBuilder;
struct JointSetBacklashT;

struct JointSetMinPositionLimit;
struct JointSetMinPositionLimitBuilder;
struct JointSetMinPositionLimitT;

struct JointSetMaxPositionLimit;
struct JointSetMaxPositionLimitBuilder;
struct JointSetMaxPositionLimitT;
...
struct JointSetBacklashT : public flatbuffers::NativeTable {
  typedef JointSetBacklash TableType;
  int32_t joint;
  double backlash;
  JointSetBacklashT()
      : joint(0),
...
struct JointSetBacklash FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef JointSetBacklashT NativeTableType;
  typedef JointSetBacklashBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_JOINT = 4,
    VT_BACKLASH = 6
  };
  ...
  JointSetBacklashT *UnPack(const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(JointSetBacklashT *_o, const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<JointSetBacklash> Pack(flatbuffers::FlatBufferBuilder &_fbb, const JointSetBacklashT* _o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};

struct JointSetBacklashBuilder {
  typedef JointSetBacklash Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_joint(int32_t joint) {
    fbb_.AddElement<int32_t>(JointSetBacklash::VT_JOINT, joint, 0);
  }
  void add_backlash(double backlash) {
    fbb_.AddElement<double>(JointSetBacklash::VT_BACKLASH, backlash, 0.0);
  }
  explicit JointSetBacklashBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  flatbuffers::Offset<JointSetBacklash> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<JointSetBacklash>(end);
    return o;
  }
};

inline flatbuffers::Offset<JointSetBacklash> CreateJointSetBacklash(
    flatbuffers::FlatBufferBuilder &_fbb,
    int32_t joint = 0,
    double backlash = 0.0) {
  JointSetBacklashBuilder builder_(_fbb);
  builder_.add_backlash(backlash);
  builder_.add_joint(joint);
  return builder_.Finish();
}

flatbuffers::Offset<JointSetBacklash> CreateJointSetBacklash(flatbuffers::FlatBufferBuilder &_fbb, const JointSetBacklashT *_o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);

struct JointSetMinPositionLimitT : public flatbuffers::NativeTable {
  typedef JointSetMinPositionLimit TableType;
  int32_t joint;
  double limit;
  JointSetMinPositionLimitT()
      : joint(0),
        limit(0.0) {
  }
};

struct JointSetMinPositionLimit FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef JointSetMinPositionLimitT NativeTableType;
  typedef JointSetMinPositionLimitBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_JOINT = 4,
    VT_LIMIT = 6
  };
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_JOINT) &&
           VerifyField<double>(verifier, VT_LIMIT) &&
           verifier.EndTable();
  }
  JointSetMinPositionLimitT *UnPack(const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(JointSetMinPositionLimitT *_o, const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<JointSetMinPositionLimit> Pack(flatbuffers::FlatBufferBuilder &_fbb, const JointSetMinPositionLimitT* _o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};

struct JointSetMinPositionLimitBuilder {
  typedef JointSetMinPositionLimit Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_joint(int32_t joint) {
    fbb_.AddElement<int32_t>(JointSetMinPositionLimit::VT_JOINT, joint, 0);
  }
  void add_limit(double limit) {
    fbb_.AddElement<double>(JointSetMinPositionLimit::VT_LIMIT, limit, 0.0);
  }
  explicit JointSetMinPositionLimitBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  flatbuffers::Offset<JointSetMinPositionLimit> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<JointSetMinPositionLimit>(end);
    return o;
  }
};

inline flatbuffers::Offset<JointSetMinPositionLimit> CreateJointSetMinPositionLimit(
    flatbuffers::FlatBufferBuilder &_fbb,
    int32_t joint = 0,
    double limit = 0.0) {
  JointSetMinPositionLimitBuilder builder_(_fbb);
  builder_.add_limit(limit);
  builder_.add_joint(joint);
  return builder_.Finish();
}

flatbuffers::Offset<JointSetMinPositionLimit> CreateJointSetMinPositionLimit(flatbuffers::FlatBufferBuilder &_fbb, const JointSetMinPositionLimitT *_o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);

struct JointSetMaxPositionLimitT : public flatbuffers::NativeTable {
  typedef JointSetMaxPositionLimit TableType;
  int32_t joint;
  double limit;
  JointSetMaxPositionLimitT()
      : joint(0),
        limit(0.0) {
  }
};

struct JointSetMaxPositionLimit FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef JointSetMaxPositionLimitT NativeTableType;
  typedef JointSetMaxPositionLimitBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_JOINT = 4,
    VT_LIMIT = 6
  };
  ...
  JointSetMaxPositionLimitT *UnPack(const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(JointSetMaxPositionLimitT *_o, const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<JointSetMaxPositionLimit> Pack(flatbuffers::FlatBufferBuilder &_fbb, const JointSetMaxPositionLimitT* _o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};

struct JointSetMaxPositionLimitBuilder {
  typedef JointSetMaxPositionLimit Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_joint(int32_t joint) {
    fbb_.AddElement<int32_t>(JointSetMaxPositionLimit::VT_JOINT, joint, 0);
  }
  void add_limit(double limit) {
    fbb_.AddElement<double>(JointSetMaxPositionLimit::VT_LIMIT, limit, 0.0);
  }
  explicit JointSetMaxPositionLimitBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  flatbuffers::Offset<JointSetMaxPositionLimit> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<JointSetMaxPositionLimit>(end);
    return o;
  }
};

inline flatbuffers::Offset<JointSetMaxPositionLimit> CreateJointSetMaxPositionLimit(
    flatbuffers::FlatBufferBuilder &_fbb,
    int32_t joint = 0,
    double limit = 0.0) {
  JointSetMaxPositionLimitBuilder builder_(_fbb);
  builder_.add_limit(limit);
  builder_.add_joint(joint);
  return builder_.Finish();
}

flatbuffers::Offset<JointSetMaxPositionLimit> CreateJointSetMaxPositionLimit(flatbuffers::FlatBufferBuilder &_fbb, const JointSetMaxPositionLimitT *_o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
struct JointStat FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  JointType joint_type() const {
    return static_cast<JointType>(GetField<int8_t>(VT_JOINT_TYPE, 0));
  }
  double units() const {
...
struct JointStatBuilder {
  ...
  void add_joint_type(JointType joint_type) {
...
inline flatbuffers::Offset<JointStat> CreateJointStat(
    flatbuffers::FlatBufferBuilder &_fbb,
    int32_t joint = 0,
    JointType joint_type = JointType_linear,
    double units = 0.0,
    double backlash = 0.0,
    double min_position_limit = 0.0,
    double max_position_limit = 0.0,
...
struct Pose FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<double>(verifier, VT_C) &&
...
struct PoseBuilder {
  ...
  flatbuffers::uoffset_t start_;
  void add_x(double x) {
    fbb_.AddElement<double>(Pose::VT_X, x, 0.0);
  }
  void add_y(double y) {
    fbb_.AddElement<double>(Pose::VT_Y, y, 0.0);
  }
  void add_z(double z) {
    fbb_.AddElement<double>(Pose::VT_Z, z, 0.0);
  }
  void add_a(double a) {
    fbb_.AddElement<double>(Pose::VT_A, a, 0.0);
  }
  void add_b(double b) {
    fbb_.AddElement<double>(Pose::VT_B, b, 0.0);
  }
  void add_c(double c) {
    fbb_.AddElement<double>(Pose::VT_C, c, 0.0);
  }
  void add_u(double u) {
    fbb_.AddElement<double>(Pose::VT_U, u, 0.0);
  }
  void add_v(double v) {
    fbb_.AddElement<double>(Pose::VT_V, v, 0.0);
  }
  void add_w(double w) {
    fbb_.AddElement<double>(Pose::VT_W, w, 0.0);
  }
...
struct TrajStatT : public flatbuffers::NativeTable {
  ...
  double scale;
  double rapid_scale;
  std::unique_ptr<PoseT> position;
  std::unique_ptr<PoseT> actual_position;
  double velocity;
  double acceleration;
  double max_velocity;
  double max_acceleration;
  std::unique_ptr<PoseT> probed_position;
  ...
  std::unique_ptr<PoseT> distance_to_go;
  double current_vel;
...
struct TrajStat FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  TrajMode mode() const {
    return static_cast<TrajMode>(GetField<int8_t>(VT_MODE, 0));
  }
  bool is_enabled() const {
    return GetField<uint8_t>(VT_IS_ENABLED, 0) != 0;
  }
  ...
  const Pose *position() const {
    return GetPointer<const Pose *>(VT_POSITION);
  }
  const Pose *actual_position() const {
    return GetPointer<const Pose *>(VT_ACTUAL_POSITION);
  }
  double velocity() const {
    return GetField<double>(VT_VELOCITY, 0.0);
  }
  ...
  const Pose *probed_position() const {
    return GetPointer<const Pose *>(VT_PROBED_POSITION);
  }
  ...
  const Pose *distance_to_go() const {
    return GetPointer<const Pose *>(VT_DISTANCE_TO_GO);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_ACTUAL_POSITION) &&
           verifier.VerifyTable(actual_position()) &&
           VerifyField<double>(verifier, VT_VELOCITY) &&
           ...
           VerifyOffset(verifier, VT_PROBED_POSITION) &&
           verifier.VerifyTable(probed_position()) &&
           ...
           VerifyOffset(verifier, VT_DISTANCE_TO_GO) &&
           verifier.VerifyTable(distance_to_go()) &&
...
struct TrajStatBuilder {
  ...
  void add_position(flatbuffers::Offset<Pose> position) {
    fbb_.AddOffset(TrajStat::VT_POSITION, position);
  }
  void add_actual_position(flatbuffers::Offset<Pose> actual_position) {
    fbb_.AddOffset(TrajStat::VT_ACTUAL_POSITION, actual_position);
  }
  void add_velocity(double velocity) {
  ...
  void add_probed_position(flatbuffers::Offset<Pose> probed_position) {
    fbb_.AddOffset(TrajStat::VT_PROBED_POSITION, probed_position);
  }
  ...
  void add_distance_to_go(flatbuffers::Offset<Pose> distance_to_go) {
    fbb_.AddOffset(TrajStat::VT_DISTANCE_TO_GO, distance_to_go);
  }
...
inline flatbuffers::Offset<TrajStat> CreateTrajStat(
    ...
    flatbuffers::Offset<Pose> position = 0,
    flatbuffers::Offset<Pose> actual_position = 0,
    double velocity = 0.0,
    double acceleration = 0.0,
    double max_velocity = 0.0,
    double max_acceleration = 0.0,
    flatbuffers::Offset<Pose> probed_position = 0,
    ...
    flatbuffers::Offset<Pose> distance_to_go = 0,
...
struct MotionStatT : public flatbuffers::NativeTable {
  ...
  std::unique_ptr<TrajStatT> traj;
  std::vector<std::unique_ptr<JointStatT>> joint;
  std::vector<std::unique_ptr<AxisStatT>> axis;
  std::vector<std::unique_ptr<SpindleStatT>> spindle;
  ...
  std::unique_ptr<PoseT> eoffset_pose;
...
struct MotionStat FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const TrajStat *traj() const {
    return GetPointer<const TrajStat *>(VT_TRAJ);
  }
  const flatbuffers::Vector<flatbuffers::Offset<JointStat>> *joint() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<JointStat>> *>(VT_JOINT);
  }
  const flatbuffers::Vector<flatbuffers::Offset<AxisStat>> *axis() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<AxisStat>> *>(VT_AXIS);
  }
  const flatbuffers::Vector<flatbuffers::Offset<SpindleStat>> *spindle() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<SpindleStat>> *>(VT_SPINDLE);
  }
  ...
  const Pose *eoffset_pose() const {
    return GetPointer<const Pose *>(VT_EOFFSET_POSE);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_EOFFSET_POSE) &&
           verifier.VerifyTable(eoffset_pose()) &&
...
struct MotionStatBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_traj(flatbuffers::Offset<TrajStat> traj) {
    fbb_.AddOffset(MotionStat::VT_TRAJ, traj);
  }
  void add_joint(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<JointStat>>> joint) {
    fbb_.AddOffset(MotionStat::VT_JOINT, joint);
  }
  void add_axis(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<AxisStat>>> axis) {
    fbb_.AddOffset(MotionStat::VT_AXIS, axis);
  }
  void add_spindle(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SpindleStat>>> spindle) {
  ...
  void add_eoffset_pose(flatbuffers::Offset<Pose> eoffset_pose) {
    fbb_.AddOffset(MotionStat::VT_EOFFSET_POSE, eoffset_pose);
  }
...
inline flatbuffers::Offset<MotionStat> CreateMotionStat(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<TrajStat> traj = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<JointStat>>> joint = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<AxisStat>>> axis = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SpindleStat>>> spindle = 0,
    ...
    flatbuffers::Offset<Pose> eoffset_pose = 0,
...
inline flatbuffers::Offset<MotionStat> CreateMotionStatDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<TrajStat> traj = 0,
    const std::vector<flatbuffers::Offset<JointStat>> *joint = nullptr,
    const std::vector<flatbuffers::Offset<AxisStat>> *axis = nullptr,
    const std::vector<flatbuffers::Offset<SpindleStat>> *spindle = nullptr,
    ...
    int32_t num_extra_joints = 0,
    bool is_jogging_active = false) {
  auto joint__ = joint ? _fbb.CreateVector<flatbuffers::Offset<JointStat>>(*joint) : 0;
  auto axis__ = axis ? _fbb.CreateVector<flatbuffers::Offset<AxisStat>>(*axis) : 0;
  auto spindle__ = spindle ? _fbb.CreateVector<flatbuffers::Offset<SpindleStat>>(*spindle) : 0;
...
struct TaskStatT : public flatbuffers::NativeTable {
  ...
  int32_t g5x_index;
  std::unique_ptr<PoseT> g92_offset;
  double rotation_xy;
  std::unique_ptr<PoseT> tool_offset;
...
struct TaskStat FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const Pose *g92_offset() const {
    return GetPointer<const Pose *>(VT_G92_OFFSET);
  }
  double rotation_xy() const {
    return GetField<double>(VT_ROTATION_XY, 0.0);
  }
  const Pose *tool_offset() const {
    return GetPointer<const Pose *>(VT_TOOL_OFFSET);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_G92_OFFSET) &&
           verifier.VerifyTable(g92_offset()) &&
           VerifyField<double>(verifier, VT_ROTATION_XY) &&
           VerifyOffset(verifier, VT_TOOL_OFFSET) &&
           verifier.VerifyTable(tool_offset()) &&
...
struct TaskStatBuilder {
  ...
  void add_g92_offset(flatbuffers::Offset<Pose> g92_offset) {
    fbb_.AddOffset(TaskStat::VT_G92_OFFSET, g92_offset);
  }
  void add_rotation_xy(double rotation_xy) {
    fbb_.AddElement<double>(TaskStat::VT_ROTATION_XY, rotation_xy, 0.0);
  }
  void add_tool_offset(flatbuffers::Offset<Pose> tool_offset) {
    fbb_.AddOffset(TaskStat::VT_TOOL_OFFSET, tool_offset);
  }
...
inline flatbuffers::Offset<TaskStat> CreateTaskStat(
    ...
    int32_t g5x_index = 0,
    flatbuffers::Offset<Pose> g92_offset = 0,
    double rotation_xy = 0.0,
    flatbuffers::Offset<Pose> tool_offset = 0,
...
struct IOStatT : public flatbuffers::NativeTable {
  ...
  int32_t reason;
  int32_t fault;
  std::unique_ptr<ToolStatT> tool;
  std::unique_ptr<CoolantStatT> coolant;
  std::unique_ptr<AuxStatT> aux;
  IOStatT()
      : debug(0),
        reason(0),
        fault(0) {
...
struct IOStat FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const ToolStat *tool() const {
    return GetPointer<const ToolStat *>(VT_TOOL);
  }
  const CoolantStat *coolant() const {
    return GetPointer<const CoolantStat *>(VT_COOLANT);
  }
  const AuxStat *aux() const {
    return GetPointer<const AuxStat *>(VT_AUX);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_DEBUG) &&
...
struct IOStatBuilder {
  ...
  void add_tool(flatbuffers::Offset<ToolStat> tool) {
    fbb_.AddOffset(IOStat::VT_TOOL, tool);
  }
  void add_coolant(flatbuffers::Offset<CoolantStat> coolant) {
    fbb_.AddOffset(IOStat::VT_COOLANT, coolant);
  }
  void add_aux(flatbuffers::Offset<AuxStat> aux) {
...
inline flatbuffers::Offset<IOStat> CreateIOStat(
    ...
    int32_t reason = 0,
    int32_t fault = 0,
    flatbuffers::Offset<ToolStat> tool = 0,
    flatbuffers::Offset<CoolantStat> coolant = 0,
    flatbuffers::Offset<AuxStat> aux = 0) {
...
struct EmcStatT : public flatbuffers::NativeTable {
  ...
  std::unique_ptr<TaskStatT> task;
  std::unique_ptr<MotionStatT> motion;
  std::unique_ptr<IOStatT> io;
  EmcStatT() {
  }
};
...
struct EmcStat FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const TaskStat *task() const {
    return GetPointer<const TaskStat *>(VT_TASK);
  }
  const MotionStat *motion() const {
    return GetPointer<const MotionStat *>(VT_MOTION);
  }
  const IOStat *io() const {
    return GetPointer<const IOStat *>(VT_IO);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct EmcStatBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_task(flatbuffers::Offset<TaskStat> task) {
    fbb_.AddOffset(EmcStat::VT_TASK, task);
  }
  void add_motion(flatbuffers::Offset<MotionStat> motion) {
    fbb_.AddOffset(EmcStat::VT_MOTION, motion);
  }
  void add_io(flatbuffers::Offset<IOStat> io) {
...
inline flatbuffers::Offset<EmcStat> CreateEmcStat(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<TaskStat> task = 0,
    flatbuffers::Offset<MotionStat> motion = 0,
    flatbuffers::Offset<IOStat> io = 0) {
...
inline AxisStatT *AxisStat::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<AxisStatT> _o = std::unique_ptr<AxisStatT>(new AxisStatT());
...
inline JointSetBacklashT *JointSetBacklash::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<JointSetBacklashT> _o = std::unique_ptr<JointSetBacklashT>(new JointSetBacklashT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void JointSetBacklash::UnPackTo(JointSetBacklashT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
...
inline flatbuffers::Offset<JointSetBacklash> JointSetBacklash::Pack(flatbuffers::FlatBufferBuilder &_fbb, const JointSetBacklashT* _o, const flatbuffers::rehasher_function_t *_rehasher) {
  return CreateJointSetBacklash(_fbb, _o, _rehasher);
}

inline flatbuffers::Offset<JointSetBacklash> CreateJointSetBacklash(flatbuffers::FlatBufferBuilder &_fbb, const JointSetBacklashT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const JointSetBacklashT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _joint = _o->joint;
  auto _backlash = _o->backlash;
  return CreateJointSetBacklash(
      _fbb,
      _joint,
      _backlash);
}

inline JointSetMinPositionLimitT *JointSetMinPositionLimit::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<JointSetMinPositionLimitT> _o = std::unique_ptr<JointSetMinPositionLimitT>(new JointSetMinPositionLimitT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void JointSetMinPositionLimit::UnPackTo(JointSetMinPositionLimitT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = joint(); _o->joint = _e; }
...
inline flatbuffers::Offset<JointSetMinPositionLimit> JointSetMinPositionLimit::Pack(flatbuffers::FlatBufferBuilder &_fbb, const JointSetMinPositionLimitT* _o, const flatbuffers::rehasher_function_t *_rehasher) {
  return CreateJointSetMinPositionLimit(_fbb, _o, _rehasher);
}

inline flatbuffers::Offset<JointSetMinPositionLimit> CreateJointSetMinPositionLimit(flatbuffers::FlatBufferBuilder &_fbb, const JointSetMinPositionLimitT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const JointSetMinPositionLimitT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _joint = _o->joint;
  auto _limit = _o->limit;
  return CreateJointSetMinPositionLimit(
      _fbb,
      _joint,
      _limit);
}

inline JointSetMaxPositionLimitT *JointSetMaxPositionLimit::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<JointSetMaxPositionLimitT> _o = std::unique_ptr<JointSetMaxPositionLimitT>(new JointSetMaxPositionLimitT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void JointSetMaxPositionLimit::UnPackTo(JointSetMaxPositionLimitT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = joint(); _o->joint = _e; }
  { auto _e = limit(); _o->limit = _e; }
...
inline flatbuffers::Offset<JointSetMaxPositionLimit> JointSetMaxPositionLimit::Pack(flatbuffers::FlatBufferBuilder &_fbb, const JointSetMaxPositionLimitT* _o, const flatbuffers::rehasher_function_t *_rehasher) {
  return CreateJointSetMaxPositionLimit(_fbb, _o, _rehasher);
}

inline flatbuffers::Offset<JointSetMaxPositionLimit> CreateJointSetMaxPositionLimit(flatbuffers::FlatBufferBuilder &_fbb, const JointSetMaxPositionLimitT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const JointSetMaxPositionLimitT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _joint = _o->joint;
  auto _limit = _o->limit;
  return CreateJointSetMaxPositionLimit(
      _fbb,
      _joint,
      _limit);
}
...
inline JointStatT *JointStat::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<JointStatT> _o = std::unique_ptr<JointStatT>(new JointStatT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline PoseT *Pose::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<PoseT> _o = std::unique_ptr<PoseT>(new PoseT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline TrajStatT *TrajStat::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<TrajStatT> _o = std::unique_ptr<TrajStatT>(new TrajStatT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline void TrajStat::UnPackTo(TrajStatT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = position(); if (_e) _o->position = std::unique_ptr<PoseT>(_e->UnPack(_resolver)); }
  { auto _e = actual_position(); if (_e) _o->actual_position = std::unique_ptr<PoseT>(_e->UnPack(_resolver)); }
  { auto _e = velocity(); _o->velocity = _e; }
  ...
  { auto _e = probed_position(); if (_e) _o->probed_position = std::unique_ptr<PoseT>(_e->UnPack(_resolver)); }
  ...
  { auto _e = distance_to_go(); if (_e) _o->distance_to_go = std::unique_ptr<PoseT>(_e->UnPack(_resolver)); }
...
inline flatbuffers::Offset<TrajStat> CreateTrajStat(flatbuffers::FlatBufferBuilder &_fbb, const TrajStatT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _position = _o->position ? CreatePose(_fbb, _o->position.get(), _rehasher) : 0;
  auto _actual_position = _o->actual_position ? CreatePose(_fbb, _o->actual_position.get(), _rehasher) : 0;
  auto _velocity = _o->velocity;
  auto _acceleration = _o->acceleration;
  auto _max_velocity = _o->max_velocity;
  auto _max_acceleration = _o->max_acceleration;
  auto _probed_position = _o->probed_position ? CreatePose(_fbb, _o->probed_position.get(), _rehasher) : 0;
  ...
  auto _distance_to_go = _o->distance_to_go ? CreatePose(_fbb, _o->distance_to_go.get(), _rehasher) : 0;
...
inline SpindleStatT *SpindleStat::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<SpindleStatT> _o = std::unique_ptr<SpindleStatT>(new SpindleStatT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline MotionStatT *MotionStat::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<MotionStatT> _o = std::unique_ptr<MotionStatT>(new MotionStatT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline void MotionStat::UnPackTo(MotionStatT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = traj(); if (_e) _o->traj = std::unique_ptr<TrajStatT>(_e->UnPack(_resolver)); }
  { auto _e = joint(); if (_e) { _o->joint.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->joint[_i] = std::unique_ptr<JointStatT>(_e->Get(_i)->UnPack(_resolver)); } } }
  { auto _e = axis(); if (_e) { _o->axis.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->axis[_i] = std::unique_ptr<AxisStatT>(_e->Get(_i)->UnPack(_resolver)); } } }
  { auto _e = spindle(); if (_e) { _o->spindle.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->spindle[_i] = std::unique_ptr<SpindleStatT>(_e->Get(_i)->UnPack(_resolver)); } } }
  ...
  { auto _e = eoffset_pose(); if (_e) _o->eoffset_pose = std::unique_ptr<PoseT>(_e->UnPack(_resolver)); }
...
inline flatbuffers::Offset<MotionStat> CreateMotionStat(flatbuffers::FlatBufferBuilder &_fbb, const MotionStatT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _joint = _o->joint.size() ? _fbb.CreateVector<flatbuffers::Offset<JointStat>> (_o->joint.size(), [](size_t i, _VectorArgs *__va) { return CreateJointStat(*__va->__fbb, __va->__o->joint[i].get(), __va->__rehasher); }, &_va ) : 0;
  auto _axis = _o->axis.size() ? _fbb.CreateVector<flatbuffers::Offset<AxisStat>> (_o->axis.size(), [](size_t i, _VectorArgs *__va) { return CreateAxisStat(*__va->__fbb, __va->__o->axis[i].get(), __va->__rehasher); }, &_va ) : 0;
  auto _spindle = _o->spindle.size() ? _fbb.CreateVector<flatbuffers::Offset<SpindleStat>> (_o->spindle.size(), [](size_t i, _VectorArgs *__va) { return CreateSpindleStat(*__va->__fbb, __va->__o->spindle[i].get(), __va->__rehasher); }, &_va ) : 0;
  ...
  auto _eoffset_pose = _o->eoffset_pose ? CreatePose(_fbb, _o->eoffset_pose.get(), _rehasher) : 0;
...
inline TaskStatT *TaskStat::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<TaskStatT> _o = std::unique_ptr<TaskStatT>(new TaskStatT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline void TaskStat::UnPackTo(TaskStatT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = g92_offset(); if (_e) _o->g92_offset = std::unique_ptr<PoseT>(_e->UnPack(_resolver)); }
  { auto _e = rotation_xy(); _o->rotation_xy = _e; }
  { auto _e = tool_offset(); if (_e) _o->tool_offset = std::unique_ptr<PoseT>(_e->UnPack(_resolver)); }
...
inline flatbuffers::Offset<TaskStat> CreateTaskStat(flatbuffers::FlatBufferBuilder &_fbb, const TaskStatT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _g92_offset = _o->g92_offset ? CreatePose(_fbb, _o->g92_offset.get(), _rehasher) : 0;
  auto _rotation_xy = _o->rotation_xy;
  auto _tool_offset = _o->tool_offset ? CreatePose(_fbb, _o->tool_offset.get(), _rehasher) : 0;
...
inline ToolStatT *ToolStat::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<ToolStatT> _o = std::unique_ptr<ToolStatT>(new ToolStatT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline CoolantStatT *CoolantStat::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<CoolantStatT> _o = std::unique_ptr<CoolantStatT>(new CoolantStatT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline AuxStatT *AuxStat::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<AuxStatT> _o = std::unique_ptr<AuxStatT>(new AuxStatT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline void IOStat::UnPackTo(IOStatT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = tool(); if (_e) _o->tool = std::unique_ptr<ToolStatT>(_e->UnPack(_resolver)); }
  { auto _e = coolant(); if (_e) _o->coolant = std::unique_ptr<CoolantStatT>(_e->UnPack(_resolver)); }
  { auto _e = aux(); if (_e) _o->aux = std::unique_ptr<AuxStatT>(_e->UnPack(_resolver)); }
}
...
inline EmcStatT *EmcStat::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<EmcStatT> _o = std::unique_ptr<EmcStatT>(new EmcStatT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline void EmcStat::UnPackTo(EmcStatT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = task(); if (_e) _o->task = std::unique_ptr<TaskStatT>(_e->UnPack(_resolver)); }
  { auto _e = motion(); if (_e) _o->motion = std::unique_ptr<MotionStatT>(_e->UnPack(_resolver)); }
  { auto _e = io(); if (_e) _o->io = std::unique_ptr<IOStatT>(_e->UnPack(_resolver)); }
}
...
#endif  // FLATBUFFERS_GENERATED_EMCSTAT_H_
